...
const RapiChat = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-[#EEEEFF] to-[#C8C7FF]">
            <div>
                <div 
                    className="chatbot-popup relative w-[420px] bg-white overflow-hidden rounded-[15px]"
                    style={{
                ...
                >
                    ...
                    <div ref={chatBodyRef} className="chat-body py-[25px] px-[22px] flex gap-[20px] h-[460px] mb-[82px] overflow-y-auto flex-col">
                    ...
                    <div className="chat-footer absolute bottom-0 w-[100%] bg-white pt-[15px] px-[22px] pb-[20px]">
                        <form 
